...
//        if (myBoardLike==1){
//            console.log('일단개추');
//            document.getElementById('thumbsdown__count')
//
//
//
...
function clickThumbDown(){
    ...
    'csrfmiddlewaretoken' : $("input[name=csrfmiddlewaretoken]").val()
        ...
        success : function(response){
        var thumbsup__count = document.getElementById('thumbsup__count')
        var thumbsdown__count = document.getElementById('thumbsdown__count')
        thumbsup__count.innerText = response['upCount'];
        thumbsdown__count.innerText = response['downCount'];
        },
    });
}